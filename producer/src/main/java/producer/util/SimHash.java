...
//        }
    ...
    public static void main(String[] args) {
        ...
        List<BigInteger> hashList = hash1.subByDistance(hash2, 3);
        ...
        LinkedListMultimap<BigInteger,SimHash> firstHashMap = LinkedListMultimap.create();
        LinkedListMultimap secondHashMap = LinkedListMultimap.create();
        LinkedListMultimap thirdHashMap = LinkedListMultimap.create();
        LinkedListMultimap fourthHashMap = LinkedListMultimap.create();

        for (int i =0;i<4;i++) {
            switch (i){
                case 0:
                    firstHashMap.put(hashList.get(0),hash1);
            }
        }

        System.out.println(firstHashMap.toString());
    }
}
